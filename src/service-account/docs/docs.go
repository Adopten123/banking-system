...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/cards/{card_id}/pin": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "ПИН-код (4 цифры)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_Adopten123_banking-system_service-account_internal_domain.SetPinRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Неверный формат ПИН-кода",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/internal/payments/verify-card": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Сырые реквизиты карты с терминала/сайта",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_Adopten123_banking-system_service-account_internal_domain.VerifyCardRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Результат проверки (is_valid и, если успешно, ID счета)",
                        "schema": {
                            "$ref": "#/definitions/github_com_Adopten123_banking-system_service-account_internal_domain.VerifyCardResult"
                        }
                    },
                    "400": {
                    ...
                    "500": {
                        "description": "Внутренняя ошибка сервера (нет связи с Сейфом или БД)",
                        "schema": {
                            "type": "string"
                        }
                    }
    ...
    "definitions": {
        ...
        "github_com_Adopten123_banking-system_service-account_internal_domain.SetPinRequest": {
            "type": "object",
            "properties": {
                "pin": {
                    "type": "string"
        ...
        "github_com_Adopten123_banking-system_service-account_internal_domain.VerifyCardRequest": {
            "type": "object",
            "properties": {
                "cvv": {
                    "type": "string"
        ...
        "github_com_Adopten123_banking-system_service-account_internal_domain.VerifyCardResult": {
            "type": "object",
            "properties": {
                "account_id": {
                    "type": "integer"
